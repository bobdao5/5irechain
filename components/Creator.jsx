      ...
      <div className="min-h-1/2 bg-gray-900 mt-36  border border-gray-900 rounded-2xl my-24">
        <div className=" lg:mx-24  flex items-center space-y-4 py-16 font-semibold text-gray-500 flex-col ">
          ...
          <form className="flex flex-col p-3 w-72 lg:w-96 md:w-96 2xl:w-96" onSubmit={handleSubmit(handleCreateToken)}>
            ...
            {isSubmitting ? (
              <button
                className="my-2 p-2 bg-gray-50 rounded-full bg-[#b9936c] font-bold text-gray-900 border border-gray-700 "
                type="submit"
                name="Create Token"
                disabled="true"
                id=""
              ...
              <button
                className="my-2 p-2 bg-gray-50 rounded-full font-bold bg[#b9936c] text-gray-900 border border-gray-700 "
                type="submit"
                name="Create Token"
                id=""
              >
